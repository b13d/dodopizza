...
export default function OrderItem(props: { order: IFrequentlyOrdered }) {
  return (
    <div className="flex mr-6 w-[260px] gap-4 items-center py-4 px-4 shadow-[0_0px_15px_-0px_rgba(0,0,0,0.1)] rounded-md h-[100px] hover:shadow-none duration-150 cursor-pointer">
